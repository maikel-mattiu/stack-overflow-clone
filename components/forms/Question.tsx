				...
				<FormField
					...
					render={({ field }) => (
						<FormItem className="flex w-full flex-col gap-3">
							...
							<FormControl className="background-light800_dark400 mt-3.5">
								<Editor
									...
									{field.value.length > 0 && (
										<div className="flex-start mt-2.5 gap-2.5">
											{field.value.map((tag) => (
												<Badge
													key={tag}
													className="background-light800_dark400 text-dark300_light900 h-8 capitalize"
												>
													{tag}
													<Image
														...
														width={12}
														height={12}
														className="cursor-pointer object-contain pl-1.5 invert-0 dark:invert"
														onClick={() =>
															form.setValue(
																"tags",
																field.value.filter(
